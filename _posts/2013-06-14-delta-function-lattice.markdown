...
{% include figure.html path="assets/img/Delta-fcn-lattice.png" caption='A visual representation of <i>U(x)</i>.' %}
</div>
...
<div style="text-align:center">
{% include figure.html path="assets/img/Bands-delta-fcn-lattice.png" caption="Energy bands in the delta-function lattice" %}
</div>
...
<div style="text-align:center">
{% include figure.html path="assets/img/Localized-states-delta-fcn-lattice.png" caption="Negative energy localized states in delta-function lattice with alpha less than 0." %}
</div>
